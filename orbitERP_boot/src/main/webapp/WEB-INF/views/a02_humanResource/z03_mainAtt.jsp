	...
	function detailAttendacne(){
		$.ajax({
			...
			success : function(att) {
				if (att!=null){
					$("#arrtime").text("출근시간 : "+att.arr_time)
					$("#deptime").text("퇴근시간 : "+att.dep_time)
				}else $("#arrtime").text("출근시간 : ")
			},
			error : function(data) {
				console.log("출근 기록 저장 실패")
			}
...
<div class="col-xl-6 col-lg-6">
	<div class="card shadow mb-4">
		...
		<div class="card-body">
					...
					<h5 class="m-0 font-weight-bold text-dark" id="todayDate">날짜</h5>
					<br>
					<h5 class="m-0 font-weight-bold text-dark" id="arrtime">출근시간</h5>
					<br>
					<h5 class="m-0 font-weight-bold text-dark" id="deptime">퇴근시간</h5>
					<br>
					<h5 class="m-0 font-weight-bold text-dark" id="tot_workhours">총 근무 시간</h5>
					<br>
